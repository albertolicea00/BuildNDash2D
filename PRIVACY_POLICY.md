...
Your privacy is very important to us. This Privacy Policy describes how we handle information in the game BuildNDash2D ("Software").

## 1. No Personal Data Collection

The Software is designed to run locally on your device or over your local network (LAN / Local Server).
- **No Account Needed:** You do not need to create an account, register, or provide any personal information (such as name, email, or phone number) to play.
- **No Data Collection:** The Software does not collect, store, or transmit any personal data or usage metrics to the Author or any third-party servers.
- **No Tracking:** We do not use cookies, trackers, analytics tools, or advertising networks inside the Software.

## 2. Local Networking (Multiplayer)

For multiplayer modes (Offline LAN / Local Server):
